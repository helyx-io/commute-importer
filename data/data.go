...
func resources_ddl_create_table_stations_sql() (*asset, error) {
	...
	info := bindata_file_info{name: "resources/ddl/create-table-stations.sql", size: 516, mode: os.FileMode(420), modTime: time.Unix(1420147279, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func resources_ddl_insert_stations_sql() (*asset, error) {
	...
	info := bindata_file_info{name: "resources/ddl/insert-stations.sql", size: 292, mode: os.FileMode(420), modTime: time.Unix(1420149789, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
