...
CREATE TABLE `agencies` (
  ...
  `agency_min_stop_lat` float DEFAULT NULL,
  `agency_max_stop_lat` float DEFAULT NULL,
  `agency_min_stop_lon` float DEFAULT NULL,
  `agency_max_stop_lon` float DEFAULT NULL,
